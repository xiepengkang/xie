<template>
    <div class="app" style="overflow-x:hidden;height:100vh;background-color: #fafafa;">
       <div class="header">
            <mt-header title="签约提醒">
                <a slot="left" @click='$router.push("/xie_news")'>
        ...
        <div class="session">
            <ul class="msgList">
                <li class="cbafter" v-for="(item,index) in msgDetail" @click='$router.push("/qygl")'>
...
export default {
    ...
    methods: {
        showMore(){
            this.pageNo++
            let params = ["",this.notificationType,this.pageNo,this.maxDisplayLength]
