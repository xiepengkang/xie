<template>
    <div class="mao_mfwtdtema">
        ...
        <p class="mao_servertell">服务电话：{{maotel}}</p>
...
<script>
import { Navbar,TabItem,Header,Button,Cell,Field,DatetimePicker,MessageBox,Indicator } from 'mint-ui';
        ...
        methods:{
            ...
            maohqfwteam(){
                ...
                commonAjax(params,'pcn.myResidentDoctorService','queryDoctorInfo').then(res=>{
                    if(res.code==200){
                        console.log(res)
                        this.qqajaxdxx(res.body.doctorInfo[0].teamId);
                        this.maotel=res.body.teamInfo[0].phoneNo;
