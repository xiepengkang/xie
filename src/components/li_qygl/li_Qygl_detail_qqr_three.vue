...
<template>
	<div class="qygl_detail_yqx">
		...
		<div class="main">
			<img src="../../assets/img/li_choose.png"/>
			<div class="qycg">
				<em>签约成功</em>
			</div>
			<div class="name">
				你已和<span>{{this.li_applyId[7]}}</span>成功签约，成为他的家庭医生
			</div>
			<div class="qycg">
				已为居民生产健康指标，点击制定
				<router-link :to="{name:'mjkzb',params:{'id': this.li_applyId[10]}}">
				<em>健康指标</em>
				</router-link>
			</div>
		</div>
...
.qygl_detail_yqx .mint-header-button{
	display: block;
	flex: 0;
}		
.qygl_detail_yqx .mint-button{
...
.qygl_detail_yqx  .mint-button-text{
		font-size: 0.37rem;
	}	
.qygl_detail_yqx  .mint-button--normal{
		font-size: 0.37rem;
