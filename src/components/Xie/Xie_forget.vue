	...
	<div class="header-grop">
		<mt-header title="忘记密码" style="background: #FFFFFF;font-size: 0.3rem;color: #000000;">
			...
			<div class="for_button" >
				<!--<button>dian</button>-->
					<mt-button type="primary" size="large" @click.native='login1'>下一步</mt-button>
...
//		18672992712
		getPassword() {
                let params = ["hcn.shenzhen",this.phones]
...
<style scoped>
	...
	.box_yam {
		border-bottom: 1px solid #22B2F5;
		height: 1.2rem;
		position:relative
	}
	.box_yam input{
