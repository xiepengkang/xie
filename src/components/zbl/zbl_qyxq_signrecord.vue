...
<div class="app" style="overflow-x:hidden;background-color:#F2F2F2;height:100vh;">
    ...
    <div class="body">
        <div class="items" v-for='item in signRecordArr'>
            <p>
            ...
            <div class="status" v-show='item.status === "2"'>已签约</div>
            <div class="status" v-show='item.status === "1"'>待确认</div>
