...
,				
    ...
    computed: {
		...mapState(['xie_aged_empi'])
    },
    methods: {
		xie_getdetailed() {
				Indicator.open('加载中...');
                let params = [JSON.parse(sessionStorage.getItem('xie_localDoctorId'))[0],JSON.parse(sessionStorage.getItem('xie_localDoctorId'))[1],this.xie_aged_empi.empiId]
                commonAjax(params, 'pcn.archiveService', 'getArchiveDetail').then(res => {
                     if (res.code == 200) {
                     	console.log(res.body)
                   this.allData=res.body;
                   //姓名
                   this.allData.personName=this.xie_aged_empi.personName;
                   //身份证
                    this.allData.idCard=this.xie_aged_empi.idCard;
                    //电话号码
                    this.allData.mobileNumber=this.xie_aged_empi.mobileNumber;
                    //性别
                    this.allData.sexCode=this.xie_aged_empi.sexCode;
                    //生日
                     this.allData.birthday=this.xie_aged_empi.birthday;
                     //判断民族
	...
	this.$refs.mould.saveData();
            ...
            return1(){
            	MessageBox({
					...
					MessageBox.confirm('确定执行此操作?').then(action => {
					this.$router.push('/xie_aged_archives')
				});
            },
...
//                   婚姻状况
            	...
            	this.isAgrRegister.forEach((item)=>{
                   ...
                   //身份证
                    ...
                    //性别
                    this.allData1.sexCode=data.sexCode
                    //生日
...
//                     医生号
                       ...
                       //empi 
                       this.allData1.empiId=this.xie_aged_empi.empiId;
                       //身份证
                       this.allData1.idCard=data.idCard;
                       //phrid
                       this.allData1.phrId=this.xie_aged_empi.phrId;
