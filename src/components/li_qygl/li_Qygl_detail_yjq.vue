...
<template>
	<div class="qygl_detail_yqx">
		...
		<div class="user_info">
			...
			<div class="info fl">
				...
				<div class="mobel">
					<div class="type">
						证件类型
						<span class="fl">{{list.idType}}</span>
					</div>
					<div class="number fr">
						证件号码
		...
		<form action="">
			...
			<mt-cell title="签约机构" value="万科">{{list.orgName}}年</mt-cell>
			<mt-cell title="签约周期" value="1年">{{list.signCycle}}年</mt-cell>
			<mt-cell title="解签时间" value="">{{list.cancelDt}}</mt-cell>
			<mt-cell title="解签申请人" value="王">{{list.personName}}</mt-cell>
		</form>
	</div>
