<template>
    <div class="app" style="overflow-x:hidden;height:100vh;background-color: #fafafa;">
        ...
        <div class="session">
            ...
            <mt-cell is-link @click.native='noOpen'>
            ...
            <ul class="toolDetail cbafter">
                <li @click='noOpen'><img src="../../assets/img/zy_tool1.png"></li>
                <li @click='noOpen'><img src="../../assets/img/zy_tool2.png"></li>
                <li @click='noOpen'><img src="../../assets/img/zy_tool3.png"></li>
                <li @click='noOpen'><img src="../../assets/img/zy_tool4.png"></li>
                <li @click='noOpen'><img src="../../assets/img/zy_tool5.png"></li>
            </ul>
        </div>
