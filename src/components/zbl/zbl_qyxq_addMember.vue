	...
	methods:{
		...
		mao_djcxyz(){
			if(this.cardType=="居民身份证"){
				if(/^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$|^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X)$/.test(this.$refs.mao_hdzhi.value)){
					let obj = {}, obj2 = {}
		...
		...mapActions(['zbl_getAddFamilyPerInfo'])
	},
	watch:{
		zoneIndex(){
