...
export default {
    ...
    filters: {
        filterIdType(value) {
            let idTypeDic = ['', '居民身份证', '居民户口簿', '护照', '军官证', '驾驶证', '港澳居民通行证', '台湾居民通行证', '', '', '', '出生证明']
        ...
        qianyuexieyi(e) {
            if (this.zbl_phoneNo && this.zbl_address.decText && this.selectDocTeam.selectTeam && this.zbl_packages.length) {
                let params = [{
                    ...
                    "person": {
                        "idCardType": this.zbl_personInfo.idType,
            ...
            if (e.currentTarget.id === 'btnBlue') {
                ...
                let params = [{
                    ...
                    "signApply": {
                        ...
                        "contactName": "",
                        "applyDt": this.date,
                        "applyUser": JSON.parse(sessionStorage.getItem('common_signApplyInfo')).mpiId, //主人的mpiId
                        "contactPhone": ""
                    },
